  ...
  return (
    <footer className="bg-black p-16">
        <div className="flex items-center justify-between">
            <div>
                <Image src="/icons/clientForceAi_logo.svg" width={148} height={28} />
                <p className="text-white text-sm max-w-[340px] mt-8">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                    eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
                    ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                    aliquip ex ea commodo consequat.
                </p>
                <div className="flex items-center h-12 w-full py-4 px-2 mt-6 max-w-xs overflow-hidden rounded-xl bg-[#1f1f1f]">
                    <input
                    type="email"
                    placeholder="Email address"
                    className="flex-1 bg-transparent px-4 text-sm text-white placeholder-gray-500 outline-none"
                    />
                    <Image src="/icons/Submit_icon.svg" width={32} height={32} className=" h-10" />
                </div>
            </div>
         ...
         <div className="flex flex-col items-center justify-between mt-8 gap-4 text-xs text-gray-500 md:flex-row">
...
// export default function Footer() {
//   return (
//     <footer className="w-full bg-[#0a0a0a] px-8 pt-16 pb-8 md:px-16">
...
//               <Image
//                 src="/images/logo.png" // ← swap to your logo
//                 alt="Clientforce AI"
//                 width={28}
//                 height={28}
//               />
//               <span className="text-lg font-bold text-white">Clientforce Ai</span>
//             </div>
...
//             {/* Email input */}
//             <div className="flex h-12 w-full max-w-xs overflow-hidden rounded-xl bg-[#1f1f1f]">
//               <input
//                 type="email"
//                 placeholder="Email address"
//                 className="flex-1 bg-transparent px-4 text-sm text-white placeholder-gray-500 outline-none"
//               />
//               <button className="m-1.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-green-500 transition hover:bg-green-400">
//                 <svg
//                   viewBox="0 0 24 24"
