...
const ANALYTICS_CARDS = [
  {
    stat: "30 - 90+",
    description: "Net-new leads/month per client (auto-prospecting + widgets",
  ...
  {
    stat: "25 - 60%",
    description: "Finstant email/WhatsApp + missed-call text-back",
  ...
  {
    stat: "2 - 5x",
    description: "More booked appointments from consistent, multi-channel follow-ups",
