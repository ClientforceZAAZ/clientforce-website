        ...
        <div ref={ref} className="bg-black pt-16 pb-10 lg:px-20">
            ...
            <div className="relative grid grid-cols-11 gap-6">
                ...
                <div className="mt-auto">
                    ...
                    <span className="font-bold">Pick A Playbook (Or Start <br /> With AI):</span> Choose The Goal + Niche, <br /> Upload PDFs For Context.
                    </p>
                </div>
                </div>
                ...
                <div>
                    <p className="text-lg leading-6">
                    <span className="font-bold">Connect Sources:</span>  Import <br /> Lists, Enable Finder v2, Add <br /> Site Widgets, Flip On WA/ <br />Voice.
                    </p>
                </div>
                </div>
                ...
                <div className="mt-auto">
                    <p className="text-lg leading-6">
                    <span className="font-bold">Launch & Prove:</span>  Track Meetings/Revenue; Share White-Label Dashboards With Clients.
                    </p>
                </div>
                </div>
            </div>
      ...
      >
        ...
        >
          <p className=" text-[44px] font-degular font-bold text-white mt-4 mb-6">
            Deploy In Minutes.{" "}
            <span className="text-[#D0F56B]">Watch It Run 24/7.</span>
          </p>
          <Link
            href="#"
