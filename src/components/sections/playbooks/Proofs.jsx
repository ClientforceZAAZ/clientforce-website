...
function WavePurple() {
  return (
    <svg viewBox="0 0 300 70" className="w-full h-auto" preserveAspectRatio="none">
      <defs>
      ...
      <path d="M0,50 C20,42 35,60 60,46 C85,32 95,56 120,42 C145,28 155,50 180,37 C205,24 220,46 250,35 C270,28 285,40 300,32 L300,70 L0,70 Z" fill="url(#waveP)" />
      <path d="M0,50 C20,42 35,60 60,46 C85,32 95,56 120,42 C145,28 155,50 180,37 C205,24 220,46 250,35 C270,28 285,40 300,32" fill="none" stroke="#a855f7" strokeWidth="2.5" strokeLinecap="round" />
...
function WaveGreen() {
  return (
    <svg viewBox="0 0 300 70" className="w-full h-auto" preserveAspectRatio="none">
      ...
      <path d="M0,65 C50,63 80,50 120,35 C160,20 200,16 240,12 C265,9 280,8 300,6 L300,70 L0,70 Z" fill="url(#waveG)" />
      <path d="M0,65 C50,63 80,50 120,35 C160,20 200,16 240,12 C265,9 280,8 300,6" fill="none" stroke="#22c55e" strokeWidth="2.5" strokeLinecap="round" />
...
function WaveOrange() {
  return (
    <svg viewBox="0 0 300 70" className="w-full h-auto" preserveAspectRatio="none">
      ...
      <path d="M0,28 C30,22 50,42 80,46 C110,50 130,32 160,42 C190,52 210,37 240,46 C265,54 280,48 300,50 L300,70 L0,70 Z" fill="url(#waveO)" />
      <path d="M0,28 C30,22 50,42 80,46 C110,50 130,32 160,42 C190,52 210,37 240,46 C265,54 280,48 300,50" fill="none" stroke="#f97316" strokeWidth="2.5" strokeLinecap="round" />
    </svg>
  );
}
...
function WaveBlue() {
  return (
    <svg viewBox="0 0 300 70" className="w-full h-auto" preserveAspectRatio="none">
      ...
      <path d="M0,55 C40,35 70,60 110,45 C150,30 170,50 200,38 C230,26 260,44 300,30 L300,70 L0,70 Z" fill="url(#waveB)" />
      <path d="M0,55 C40,35 70,60 110,45 C150,30 170,50 200,38 C230,26 260,44 300,30" fill="none" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round" />
...
const WAVES = { purple: WavePurple, green: WaveGreen, orange: WaveOrange, blue: WaveBlue, bar: WaveBars };
const BG_COLORS = {
  purple: "#F5D6F8",
  green:  "#E3FFED",
  orange: "#FACBB2",
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered ? `0 16px 48px rgba(0,0,0,0.12)` : "0 4px 20px rgba(0,0,0,0.06)",
        background: bg,
        // minWidth: "316px",
        // maxWidth: "400px",
        width: "316px",
    ...
    >
      ...
      {/* Description */}
      <p className="text-[15px] text-[#3B3B3B] mt-10 leading-relaxed flex-1">{description}</p>
      ...
      <div className="flex items-center gap-2 mt-4 pt-3 border-t border-black/5">
        ...
        <div>
          <p className="text-[12px] font-bold leading-tight" style={{ color: nc }}>{name}</p>
...
const ANALYTICS_CARDS = [
  {
    stat: "+14%",
    description: "Subject Variant B lifted opens +14% for SaaS CTOs → Auto-promoted",
  ...
  {
    stat: "+22%",
    description: "Voice after Step 3 increased meetings +22% in Local Services",
  ...
  {
    stat: "+11%",
    description: "Proof-first email outperformed benefits-first +11% in Healthcare cohort",
  ...
  {
    stat: "38%",
    description: "New domain warmed up — complaints dropped 38% in first week",
    avatar: "/images/multichannel-outreach/elaine_morris.png",
    name: "Dr. Elaine Morris",
    role: "B2B Sales Consultant & Author",
    wave: "bar",
