  ...
  return (
    ...
    >
      <div>
        <div className="flex items-center justify-center mb-2">
          <div className="relative p-0.5 rounded-full bg-[linear-gradient(270deg,#F437AB,#08A541,#08A541,#FF9D7C)]">
            <div className="bg-[#010201] text-white rounded-full px-3 py-1 flex items-center justify-center">
              <span className="text-xs sm:text-sm font-bold">Products</span>
            </div>
          </div>
        </div>
        <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold font-degular text-[#787878] text-center">
        ...
        <p className="px-10 font-medium text-xs sm:text-lg text-[#FFFFFF99] text-center mt-2 sm:mt-4 leading-4 sm:leading-6">
          Set it up once. Your Agents auto-prospect, message across channels,
          place <br className="hidden sm:block" /> calls, send dynamic
          proposals, and book deals—24/7.
        </p>
        ...
        <div className="relative mt-14">
            ...
            <div className="relative flex items-center justify-center w-15 h-15 sm:w-30 sm:h-30">
              ...
              <span className="relative inline-flex rounded-full bg-black shadow-md">
                <img
                  ...
                  alt="Play"
                  className="w-10 sm:w-15 h-10 sm:h-15"
                />
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center">
            <div className="p-4 bg-gradient-to-b from-[#545f55] to-[#17331B17] rounded-2xl ">
              <Image
                src="/images/agents/agentHero.png"
                width={849}
                height={427}
                className=" "
              />
