  ...
  return (
    <div ref={ref} className="">
      ...
      <LongHorizontalCard
        ...
        titleTextStyle="text-[30px] text-black leading-12 mb-0"
        description=""
        descriptionTextTyle=""
        delay="0.2s"
        className="bg-white border border-[#00000024] p-8 gap-12 mb-10"
        visible={visible}
        imageLeft={true}
        moreDescription={
          <>
            <div className="mt-2 flex flex-col gap-4 justify-between items-start w-full">
              <div className="flex items-center gap-4 w-full bg-[#FFFFFF1C] border border-[#0AD85533] p-3 rounded-lg">
                ...
                <p className="text-black text-base font-light w-full">
          ...
          <>
            <div className="mt-2 flex flex-col gap-4 justify-between items-start w-full">
              <div className="flex items-center gap-4 w-full bg-[#FFFFFF1C] border border-[#0AD85533] p-3 rounded-lg">
                <Image src="/images/agents/icons/compliance_email.svg" width={45} height={45} />
                <p className="text-black text-base font-light w-full">
                  <span className="font-bold">Timezone-Aware Sending:</span> Timezone-Aware Sending: Respect recipient local time with business-day calendars and holiday holds.
                </p>
              </div>
              <div className="flex items-center gap-4 w-full bg-[#FFFFFF1C] border border-[#0AD85533] p-3 rounded-lg">
                <Image src="/images/agents/icons/compliance_whatsapp.svg" width={45} height={45} />
