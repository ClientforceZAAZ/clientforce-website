        ...
        <div ref={ref} className="bg-black pt-16 pb-10 lg:px-20">
            ...
            <div className="relative grid grid-cols-11 gap-6">
                ...
                <div className="mt-auto">
                    ...
                    <span className="font-bold">Define Motion:</span> Demos, Trial→Paid, Expansion, Or Win-Back (Or Run Multiple Agents In Parallel).
                    </p>
                </div>
                </div>
                ...
                <div>
                    <p className="text-lg leading-6">
                    <span className="font-bold"> Add Knowledge:</span> Upload Pricing Sheets, Decks, Case Studies; The Agent Learns Your Story.
                    </p>
                </div>
                </div>
                ...
                <div className="mt-auto">
                    <p className="text-lg leading-6">
                    <span className="font-bold">Launch & Optimize:</span> A/B Subjects, Step Performance, Deliverability Health, Number Reputation.
                    </p>
                </div>
                </div>
            </div>
