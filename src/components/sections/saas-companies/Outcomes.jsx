...
const ANALYTICS_CARDS = [
  {
    stat: "+30 - 70%",
    description: "More qualified demos from ICP campaigns and instant follow-ups",
  ...
  {
    stat: "+15 - 35%",
    description: "+15–35% lift in trial-to-paid conversion with activation sequences and voice nudges",
  ...
  {
    stat: "2 - 5x",
    description: "Faster deal cycles from dynamic proposals tailored to role, industry, and pain",
