  ...
  return (
    <section className="py-10 pl-6 flex items-center justify-center">
      <div
        ...
        >
          <div className="flex flex-col items-center justify-center px-54 py-27">
            <h2 className="text-[#00000066] text-[40px] font-degular">Press Play</h2>
            <h1 className="font-bold text-6xl  max-w-[686px] text-center font-degular">watch one setup turn into a 24/7 sales machine.</h1>
            <p className="text-lg text-[#676767] text-center font-dm mt-6">See an Agent find leads, send messages, place a live call, <br /> and book a meeting—no manual follow-up.</p>
