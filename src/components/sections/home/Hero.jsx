...
export default function Hero() {
  return (
    <PageHero
      ...
      headline={<>Launch Once. <br /> Sell 24/7. <span className="inline-block"><Image src="/images/face notifications.png" alt="Logo" width={140} height={55} /></span></>}
      headlineStyle="text-5xl lg:text-[80px] leading-18"
      ...
      metrics={<>
        ...
        <span className="flex items-center gap-1"><img src="/icons/video_icon.svg" alt="video call icon" />37 Meetings in 7 Days</span>
        <span className="flex items-center gap-1"><img src="/icons/phone.svg" alt="Ai call icon" />$42k Closed Via AI Voice</span>
      </>}
      rightImage={
          <>
            <div className="relative pt-10 pb-10 pl-26">
              <Image src="/images/hero_dashboard.png" alt="Dashboard Preview" height={1200} width={1060} className="w-full h-auto" priority />
            </div>
          </>
          }
      floatingCards={<>
        <div className="absolute top-[20%] left-[6%] w-[53%] z-30"><AgentModalCard /></div>
        <div className="absolute bottom-[10%] left-[6%] w-[45%] z-30"><HeroLiveFeedCard /></div>
      </>}
    />
  );
}
