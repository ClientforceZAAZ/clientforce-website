  ...
  return (
    <div className="mb-2 border border-gray-300 px-4 py-4 shadow rounded-2xl">
      ...
      <div className="relative h-2 w-full rounded-full bg-gray-200">
        {/* Filled portion */}
        <div
          className="absolute left-0 top-0 h-2 rounded-full bg-green-400 transition-all duration-150"
          style={{ width: `${pct}%` }}
        />
        <input
          type="range"
...
export default function AgentRoiCard() {
  ...
  const formatted = `$${monthlyRevenue.toLocaleString()}+`;
  ...
  return (
    ...
    >
      ...
      {/* Result */}
      <div>
        <p className="text-[28px] text-[#787878]">Project Monthly Revenue:</p>
        <p className="my-1 text-5xl font-bold tracking-tight text-black">
          {formatted}
        </p>
