...
export default function ClientForceFix() {
  return (
    <section className="relative">
      <div className="flex">
        <div
          className="bg-cover bg-center w-1/2 pt-10 font-degular"
          style={{ backgroundImage: "url('/images/the_fix_bg.png')" }}
        >
          <div className=" flex items-center justify-center">
            <h1 className=" font-bold text-2xl bg-[#C4FAFF] px-8 py-2 rounded-[73px] w-fit text-center">
              The Fix
            </h1>
          </div>
          <h1 className="text-center font-bold text-7xl mt-2">Perpetual</h1>
          <h1 className="text-center font-bold text-7xl mt-2 text-white">
            Ai Sales Agents
          </h1>
        ...
        <div className=" w-1/2   bg-[linear-gradient(180deg,#000015_0%,#000015_25%,#000015_50%,#000015_60%,#102338_85%,#28586d_100%)] flex flex-col gap-8 justify-center pl-18">
        <p className=" text-xl text-white max-w-[470px]">
