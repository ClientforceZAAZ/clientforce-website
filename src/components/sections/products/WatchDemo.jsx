...
export default function WatchDemo() {
  return (
    <section className="py-0 lg:py-15 pl-6 flex items-center justify-center">
      <div
        ...
        >
          <div className="flex flex-col items-center justify-center px-8 sm:px-20 lg:px-50 py-6 sm:py-16 lg:py-40">
  ...
  <Link
    href="#"
    className="flex items-center justify-center w-full sm:w-auto text-base md:text-xl font-bold bg-radial from-[#35E834] from-20% to-[#D0F56B] hover:from-[#D0F56B] hover:from-10% hover:to-[#35E834] transition delay-100 duration-200 ease-in-out pl-1 pr-4 py-2 rounded-full font-degular"
  >
    <div className="relative flex items-center justify-center w-8 h-8 md:w-12 md:h-12  mr-2">
      {/* Pulse Ring */}
      <span className="absolute inline-flex h-full w-full rounded-full bg-black opacity-40 animate-ping"></span>

      {/* Static Circle */}
      <span className="relative inline-flex rounded-full bg-black shadow-md w-6 h-6 md:w-12 md:h-12 items-center justify-center flex">
