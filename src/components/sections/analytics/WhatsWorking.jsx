    ...
    <section className="relative">
        <div className="bg-cover bg-center flex flex-col items-center justify-center z-10"
          ...
          style={{ backgroundImage: "url('/images/agent_roi_bg2.png')" }}>   
                <p className=" text-2xl sm:text-3xl md:text-4xl lg:text-[44px] font-degular text-white mt-4 mb-2 sm:mb-6 text-center">See Exactly What’s Working <br className="block lg:hidden" />—And Scale It.</p> 
                <Link href="#"  className="font-bold text-base sm:text-lg md:text-2xl bg-[#35E834] rounded-full px-8 py-2 border-[3px] border-white hover:scale-105 transition-all ease-in-out" style={{
                ...
                <div className="mt-6 sm:mt-12 relative">
                    ...
                    <div className="absolute inset-0">
                         ...
                         <div className="absolute bottom-[8%] left-20  lg:left-[-110] z-30 hidden md:block">
                                <DropOffResponseCard />
                         </div>
