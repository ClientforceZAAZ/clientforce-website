...
const MODULES = [
  {
    ...
    preview: (
      <img src="/images/analytics/campaign_overview.png" alt="Campaign Overview Dashboard" className="w-full rounded-2xl border border-gray-100 shadow-sm" />
    ),
  },
  {
    id: 2,
    label: "Step Analytics",
    title: "Step Analytics (What's Working & Where)",
    bullets: [
      { bold: "", text: "Per-step metrics: opens, clicks, replies, positive replies, booked, unsubscribes" },
      { bold: "Voice analytics:", text: " connect rate, talk time, outcome, objection tags" },
      { bold: "WhatsApp/SMS:", text: "  delivery, read rate, quick-reply engagement" },
       { bold: "", text: "  “Drop-off” and “Lift” indicators highlight bottlenecks & step improvements" },
    ],
    preview: (
      <img src="/images/analytics/step_analytics.png" alt="Step Analytics Dashboard" className="w-full rounded-2xl border border-gray-100 shadow-sm" />
    ),
  },
  {
    id: 3,
    ...
    title: "Channel Mix Performance",
    bullets: [
      { bold: "", text: (<>Compare <span className="font-bold">Email vs WhatsApp</span> vs LinkedIn vs Voice by goal</>) },
      { bold: "", text: " Recommended redistribution (e.g., “Shift +10% volume to Voice after Step 3”)" },
    ],
    preview: (
      <img src="/images/analytics/channel_mix.png" alt="Channel Mix Performance Dashboard" className="w-full rounded-2xl border border-gray-100 shadow-sm" />
    ),
  },
  {
    id: 4,
    ...
    title: "Outcome & Revenue Attribution",
    bullets: [
      { bold: "Revenue Per Campaign:", text: (<>Meetings and revenue credited to <span className="font-bold">message step, channel, template, playbook</span></>) },
      { bold: "", text: "Multi-touch attribution (first touch, last touch, weighted)" },
  
    ],
    preview: (
      <img src="/images/analytics/revenue_attribution.png" alt="Revenue Attribution Dashboard" className="w-full rounded-2xl border border-gray-100 shadow-sm" />
    ),
  },
  {
    id: 5,
    ...
    title: "Cohorts & Segments",
    bullets: [
      { bold: "", text: (<>Break down by <span className="font-bold">industry, role, company size, geo, list source</span></>) },
      { bold: "", text: "Spot “where you win” and clone winning plays with 1 click" },
     
    ],
    preview: (
      <img src="/images/analytics/cohorts_segments.png" alt="Cohorts & Segments Dashboard" className="w-full rounded-2xl border border-gray-100 shadow-sm" />
    ),
  },
  {
    id: 6,
    ...
    title: "Experiment Lab (A/B Testing)",
    bullets: [
      { bold: "", text: " Subject/body variants, send-time tests, call scripts" },
      { bold: "Auto-promote", text: " winners after significance; archive losers" },
      { bold: "", text: " Variant heatmap: which angles (benefit, objection, proof) convert" },
    ],
    preview: (
      <img src="/images/analytics/experiment_lab.png" alt="Experiment Lab Dashboard" className="w-full rounded-2xl border border-gray-100 shadow-sm" />
    ),
  },
  {
    id: 7,
    ...
    title: "Deliverability & Number Reputation",
    bullets: [
      { bold: "", text: " Email: inbox placement score, bounce/spam trend, domain warm-up, DNS status" },
      { bold: "", text: "Voice: number reputation, STIR/SHAKEN, CNAM, connection rates" },
      { bold: "", text: " One-click fixes: rotate senders, throttle, warm-up boost, number swap" },
    ],
    preview: (
      <img src="/images/analytics/deliverability.png" alt="Experiment Lab Dashboard" className="w-full rounded-2xl border border-gray-100 shadow-sm" />
    ),
  },
  {
    id: 8,
    ...
    title: "Compliance & Guardrails Health",
    bullets: [
      { bold: "", text: " DNC hits, consent rates (GDPR/TCPA), WhatsApp template approvals" },
      { bold: "", text: " Alerts with recommended remediations" },
    ],
    preview: (
      <img src="/images/analytics/compliance_guardrails.png" alt="Experiment Lab Dashboard" className="w-full rounded-2xl border border-gray-100 shadow-sm" />
    ),
  },
  {
    id: 9,
    ...
    title: "SLA & Speed To Lead",
    bullets: [
      { bold: "", text: " Time-to-first-touch, follow-up latency, response SLAs per channel" },
      { bold: "", text: "“Missed SLA” triggers for real-time agent catch-ups" },
      { bold: "Response Velocity Trends:", text: " Week-over-week improvement tracking" },
    ],
    preview: (
      <img src="/images/analytics/sla_speed_to_lead.png" alt="SLA & Speed To Lead Dashboard" className="w-full rounded-2xl border border-gray-100 shadow-sm" />
    ),
  },
  {
    id: 10,
    ...
    title: "Alerts & AI Recommendations",
    bullets: [
      { bold: "", text: "Anomaly detection: sudden bounce spike, reply drop, number flagged" },
      { bold: "", text: " AI suggests fixes: “Shorten Step 2 delay,” “Swap Step 4 angle to proof,” “Re-warm domain”" },
    ],
    preview: (
      <img src="/images/analytics/alerts_recommendations.png" alt="Alerts & AI Recommendations Dashboard" className="w-full rounded-2xl border border-gray-100 shadow-sm" />
    ),
  },
];
...
export default function DashboardsModules() {
  ...
  return (
    <section ref={ref} className="py-20 px-6 lg:px-16 bg-[#EEF9FA] relative overflow-hidden">
      ...
      >
        <div className="bg-[#D0F56B] text-black font-bold text-2xl lg:text-[40px] font-degular px-8 py-2 rounded-2xl shadow-sm">
          Dashboards & Modules
        </div>
      </div>

      {/* Grid Layout: 1 column on mobile, 2 columns on medium+ */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto relative z-10">
        {MODULES.map((module, index) => (
          <div
            ...
            className="flex flex-col border border-black/10 rounded-3xl bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300"
          >
            {/* Top Section: Dashboard Preview */}
            <div className="bg-gradient-to-br from-[#e0f2fe] to-[#d1fae5] p-4 flex items-center justify-center min-h-[220px]">
            ...
            <div className="p-8 flex-1 flex flex-col">
              <div className="flex items-center gap-3 mb-4">
                {/* <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#D0F56B] text-black font-bold text-sm">
                  {module.id}
                </span> */}
                ...
                {module.bullets.map((bullet, i) => (
                  <div key={i} className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <Image src="/icons/Done.svg" width={20} height={20} alt="check" />
                    </div>
                    <p className="text-sm lg:text-base text-gray-800 leading-relaxed">
                      <span className="font-bold text-black">{bullet.bold}</span>
                      {bullet.text}
                    </p>
                  </div>
                ))}
      ...
      <Image src="/images/guardrails/Ellipse_guardrails_right.png" width={400} height={250} className="absolute bottom-[-20] left-0 -z-0 pointer-events-none opacity-50" alt="" />
      <Image src="/images/guardrails/Ellipse_guardrails_left.png" width={400} height={250} className="absolute bottom-[-20] right-0 -z-0 pointer-events-none opacity-50" alt="" />
      
      <Image src="/images/guardrails/icons/right.svg" width={50} height={50} className="absolute top-1/4 right-4 hidden lg:block" alt="" />
      <Image src="/images/guardrails/icons/left.svg" width={50} height={50} className="absolute top-3/4 left-4 hidden lg:block" alt="" />
