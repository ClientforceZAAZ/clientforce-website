...
//   const suffix = stat.replace(/[0-9+]/g, "").trim();
  ...
  return (
    ...
    >
      ...
      {/* Description */}
      <p className="text-[15px] text-[#3B3B3B] mt-10 leading-5 flex-1">{description}</p>
...
//   }
  ...
  return (
    <section ref={ref} className="pt-10 pb-10 px-6 lg:px-16 bg-[#E1F1F2]">
     ...
     <h1 className="text-5xl font-bold text-center mb-12 font-degular">Revenue Outcomes</h1>
...
const ANALYTICS_CARDS = [
  {
    stat: "60 - 90+",
    description: "+30–70% more qualified demos from ICP campaigns and instant follow-ups",
  ...
  {
    stat: "20 - 40%",
    description: "lift in booked appointments from consistent follow-ups",
  ...
  {
    stat: "2 - 5x",
    description: "Steady stream of fresh local leads via Finder v2 + Chrome Capture",
