        ...
        <div ref={ref} className="bg-black pt-16 pb-10 lg:px-20">
            ...
            <div className="relative grid grid-cols-11 gap-6">
                ...
                <div className="mt-auto">
                    ...
                    <span className="font-bold">Choose Your Goal:</span>  Book Service Calls, Request Quotes, Or Membership Renewals.
                    </p>
                </div>
                </div>
                ...
                <div>
                    <p className="text-lg leading-6">
                    <span className="font-bold"> Turn On Sources:</span> Widget On Your Site, Finder V2, And One-Click Chrome Capture.
                    </p>
                </div>
                </div>
                ...
                <div className="mt-auto">
                    <p className="text-lg leading-6">
                    <span className="font-bold">Let It Run:</span> Your Agent Follows Up Across Email/WhatsApp/Voice Until The Job Is Booked.
                    </p>
                </div>
                </div>
            </div>
